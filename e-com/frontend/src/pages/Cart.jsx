  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 min-h-[75vh]">
      ...
      <div className="flex items-center justify-between border-b border-white/5 pb-6 mb-10 text-left">
        <div>
          <span className="text-xs font-black text-accent tracking-widest uppercase">Your Selection</span>
      ...
      {cartItems.length > 0 ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-4 ios-glass rounded-[24px] p-6 space-y-6 sticky top-28 text-left">
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex justify-between text-xs text-neutral-400">
                ...
                {shippingFee === 0 ? (
                  <span className="text-accent font-bold tracking-widest">FREE</span>
                ) : (
              ...
              {totalAmount < 300 && (
                <p className="text-[10px] text-neutral-500 italic bg-white/5 p-2 rounded-xl border border-white/5">
                  Add <span className="text-accent font-bold">${300 - totalAmount}</span> more for free secure shipping!
                </p>
              )}
              ...
              <div className="flex justify-between items-baseline pt-2">
                ...
                <span className="text-xl font-black text-accent shadow-sm shadow-accent/10">${grandTotal}</span>
              </div>
            ...
            <div className="pt-4 space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-4 bg-brand-accent text-black font-extrabold text-xs tracking-widest uppercase rounded-full min-h-[44px] hover:scale-[1.02] active:scale-[0.98] transition duration-200 cursor-pointer shadow-lg shadow-brand-accent/10 focus:outline-none focus:ring-2 focus:ring-brand-accent focus:ring-offset-2 focus:ring-offset-transparent"
              >
        ...
        <motion.div
          ...
          className="text-center py-20 ios-glass rounded-[24px] border border-white/8"
        >
          <div className="inline-flex p-4 bg-accent/10 rounded-full text-accent mb-4 animate-pulse">
          ...
          <Link
            to="/products"
            className="mt-8 inline-flex items-center gap-2 px-8 py-3.5 bg-brand-accent text-black font-extrabold text-xs tracking-widest uppercase rounded-full min-h-[44px] hover:scale-105 transition duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-brand-accent focus:ring-offset-2 focus:ring-offset-transparent"
          >
